                ...
                <td>
                    <form action="<pwm:current-url/>" method="post" enctype="application/x-www-form-urlencoded" name="search">
                        <button class="btn" type="submit" name="submitBtn">
                            ...
                            <pwm:display key="Button_UnlockApplication"/>
                        </button>
                        <input type="hidden" name="choice" value="unlockApplication"/>
                        <input type="hidden" name="processAction" value="<%=ForgottenPasswordServlet.ForgottenPasswordAction.actionChoice%>"/>
                        <input type="hidden" name="pwmFormID" value="<pwm:FormID/>"/>
                    </form>
                </td>
                <td>
                    <pwm:display key="Display_RecoverChoiceUnlockApplication"/>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <form action="<pwm:current-url/>" method="post" enctype="application/x-www-form-urlencoded" name="search">
                        <button class="btn" type="submit" name="submitBtn">
                            ...
                            <pwm:display key="Button_ResetApplicationToInitialPassword"/>
                        </button>
                        <input type="hidden" name="choice" value="resetApplicationToInitialPassword"/>
                        <input type="hidden" name="processAction" value="<%=ForgottenPasswordServlet.ForgottenPasswordAction.actionChoice%>"/>
                        <input type="hidden" name="pwmFormID" value="<pwm:FormID/>"/>
                    </form>
                </td>
                <td>
                    <pwm:display key="Display_RecoverChoiceResetApplicationToInitialPassword"/>
                </td>
            </tr>
            <tr>
                <td>
