...
public enum Message implements PwmDisplayBundle {
    ...
    Success_UnlockApplication(null),
    Success_ConfigFileUpload(null),
    Success_PasswordReset(null),
    Success_ResetApplicationToInitialPassword(null),
    ...
    EventLog_UnlockApplication(null),
    EventLog_RecoverPassword(null),
    EventLog_ResetApplicationToInitialPassword(null),
