...
public enum Display implements PwmDisplayBundle {
    ...
    Button_ResetApplicationToInitialPassword,
    ...
    Display_RecoverChoiceResetApplicationToInitialPassword,
    Display_RecoverChoiceUnlock,
    Display_RecoverChoiceUnlockApplication,
